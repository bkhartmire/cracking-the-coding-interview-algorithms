// 4.1 Implement a fnction to check if a binary tree is balanced.
// For the purposes of this question, a balanced tree is defined to be a tree such that the heights of the two subtrees
...
// You may assum that each node has a link to its parent.

// 4.7 Design an algorithm and write code to find teh first common ancestor of two nodes in a binary tree.
// Avoid storing additional nodes in a data structure. NOTE: This is not necessarily a binary search tree.

// 4.8 You ahve two very large binary trees: T1, with millions of nodes, and T2, with hundreds of nodes.
// Create an alogirthm to decide if T2 is a subtree of T1.
